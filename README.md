...
Classificar as ligações por número de origem e agrupa-las com o valor total da das ligacões feitas por esse número. 
Complete o método *classify_by_phone_number* que recebe por parâmetro um relatório em forma de lista de dicionários.
Os horários de início de fim das ligacões estão no formato timestamp e os números de telefone no formato de strings, 
...
O valor total deve ser arredondado em 2 casas decimáis.
